...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    cb(null, __dirname + "/tmp/public/images");
  },
  ...
  if (
    ...
    req.body.authorbackground
        ...
        About.findOneAndUpdate(
          ...
          $set:{
            avatar: { data: JSON.parse(fs.readFileSync(path.join(__dirname + "/tmp/public/images/" + req.file.filename))), 
            contentType: "images/*" },
            name: req.body.authorname,
        ...
        const post = new Posts({
          ...
          postImage: {
            data: JSON.parse(fs.readFileSync(
              path.join(__dirname + "/tmp/public/images/" + req.file.filename)
            )),
            contentType: "image/*",
          },
